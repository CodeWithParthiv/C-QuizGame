...
int main()
{
    ...
    if(i==7)
    {
         ...
         else
         {
              ...
              point01 = 0;
              printf("You have scored %d point\n", point01);
              printf("The correct option is Archie\n\n\n");
         }
         ...
         else
         {
              ...
              point02 = 0;
              printf("You have scored %d point\n", point02);
              printf("The correct option is Nexus\n\n\n");
         }
         ...
         else
         {
              ...
              point03 = 0;
              printf("You have scored %d point\n", point03);
              printf("The correct option is Creeper Virus\n\n\n");
         }
         ...
         else
         {
              ...
              point04 = 0;
              printf("You have scored %d point\n", point04);
              printf("The correct option is Security\n\n\n");
         }
         ...
         else
         {
              ...
              point05 = 0;
              printf("You have scored %d point\n", point05);
              printf("The correct option is cobal\n\n\n");
         }
    }
